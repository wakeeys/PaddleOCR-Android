...
public class OCRPredictorNative {
    ...
    public ArrayList<com.example.questionextractionmodule.OcrResultModel> runImage(Bitmap originalImage, int max_size_len, int run_det, int run_cls, int run_rec) {
        ...
        ArrayList<com.example.questionextractionmodule.OcrResultModel> results = postprocess(rawResults);
        return results;
    }
